...
Als je een beveiligingsprobleem vindt, bijvoorbeeld een lek waardoor secrets uitlekken, een manier om de QR-token-validatie te omzeilen, een upload-route die meer accepteert dan zou moeten, of iets anders dat mij in de problemen kan brengen: meld het dan **niet** in een publieke issue.

Stuur in plaats daarvan een e-mail naar **beheer@sluiskade.com** met:
